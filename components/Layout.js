      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40">
        <div className="px-4 sm:px-6 py-3 flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center gap-6"><Link href="/" className="text-2xl font-bold text-blue-600 dark:text-blue-400">PlainUtils</Link>
            <nav className="hidden md:flex gap-5 text-sm font-medium" aria-label="Main navigation"><Link href="/tools">Tools</Link><Link href="/workspace" className="flex items-center gap-1.5"><Workflow className="w-4 h-4"/>Workflows</Link><Link href="/about">About</Link><Link href="/privacy">Privacy</Link><Link href="/contact">Contact</Link></nav>
          </div>
        ...
        {menuOpen && <nav className="md:hidden px-6 pb-4 grid gap-3" aria-label="Mobile navigation"><Link href="/tools">Tools</Link><Link href="/workspace" className="flex items-center gap-2"><Workflow className="w-4 h-4"/>Workflows</Link><Link href="/about">About</Link><Link href="/privacy">Privacy</Link><Link href="/contact">Contact</Link></nav>}
      </header>
