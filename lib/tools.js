import {
  ...
  NotebookPen, Palette, Regex, ShieldCheck, TableProperties, TextCursorInput, Timer, WandSparkles,
} from 'lucide-react';
...
export const tools = [
  ...
  { title: 'Markdown Studio', href: '/tools/markdown-preview', category: 'Text Tools', description: 'Write, preview, search, and export sanitized GitHub-flavoured Markdown.', icon: NotebookPen },
  ...
  { title: 'CSV Viewer & Converter', href: '/tools/csv-viewer', category: 'Data Tools', description: 'Inspect, filter, sort, clean, and convert CSV, TSV, and JSON locally.', icon: TableProperties },
  { title: 'YAML ↔ JSON Converter', href: '/tools/yaml-json', category: 'Data Tools', description: 'Convert complete YAML documents to JSON and JSON back to YAML.', icon: FileJson },
  ...
  { title: 'Code Minifier', href: '/tools/code-minifier', category: 'Developer Tools', description: 'Minify HTML, CSS, and JavaScript locally with parser-aware engines.', icon: FileCode2 },
